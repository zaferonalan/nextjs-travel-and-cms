...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white relative">
        <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-orange-500 text-left px-6 py-12 rounded-md shadow-lg w-11/12 
      ...
      <div className="container mx-auto py-56 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-8">
        ...
        <div className="lg:col-span-2 mt-16">
          <h4 className="text-xl mb-4 font-bold">İnstagram</h4>
